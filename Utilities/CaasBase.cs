...
{
    public class CaasBase:AbstractComponent
    {
        ...
        string newUrl = "https://caas.devops-gto15-install.eng.ssnsgs.net:6343/caas/login";
        ...
        public void loginHeadEnd()
        {
            ...
            string? browser = UIQSettings.Default.Browser;
         ...
         //   driver.Url = newUrl;
           ...
           // updateConfigFile(GlobalVariables.testData, get);
            ...
            waitForElementVisible(By.XPath(getLocatorFromResource("CaasLoginInputBox", "", "username")),driver);
            GlobalVariables.CaasUsername = UIQSettings.Default.Cass_Username;
            GlobalVariables.CaasPassword = UIQSettings.Default.Caas_Password;
            GlobalVariables. DBType=UIQSettings.Default.DBType;


            FindElement<IWebElement>(getLocatorFromResource("CaasLoginInputBox", "", "username"),false).SendKeys(GlobalVariables.CaasUsername);
            FindElement<IWebElement>(getLocatorFromResource("CaasLoginInputBox", "", "password"), true,1000).SendKeys(GlobalVariables.CaasPassword);
            FindElement<IWebElement>(getLocatorFromResource("CaasLoginInputBox", "", "submit"), true,2000).Click();
            ...
            FindElement<IWebElement>(xpath, true).Text.Contains("Your applications");
